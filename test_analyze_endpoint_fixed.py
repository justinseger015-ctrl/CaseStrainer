#!/usr/bin/env python3
"""
Test the /analyze endpoint after fixing the backend to use extraction function
"""

import requests
import json

def test_analyze_endpoint_fixed():
    """Test the /analyze endpoint that now uses the extraction function"""
    ...
    print("🧪 Testing /analyze endpoint (now with extraction function)...")
    print(f"URL: {url}")
        ...
        if response.status_code == 200:
            ...
            if 'citations' in result and result['citations']:
                ...
                if extracted_name != 'N/A' and extracted_date != 'N/A':
                    ...
                    print("✅ Backend fix successful - extraction function is being called!")
                else:
