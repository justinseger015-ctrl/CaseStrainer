...
try:
    ...
    with open(config_path, 'r') as f:
        ...
        logger.info(f"Loaded CourtListener API key from config.json: {COURTLISTENER_API_KEY[:5]}...")
...
def analyze():
    ...
    try:
        ...
        if 'file' in request.files:
            ...
            verified_citations = [verify_citation(citation['citation'], citation.get('context', '')) for citation in citations]
