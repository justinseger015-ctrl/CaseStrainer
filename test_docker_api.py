#!/usr/bin/env python3
"""
Test the Docker container API on port 80
"""
...
def test_docker_api():
    ...
    try:
        print("\nSending request to Docker container (port 80)...")
        ...
        print("❌ Connection failed - Docker containers may not be running")
        print("Try running: .\\dplaunch.ps1 -Mode Production -QuickStart")
    ...
    try:
        ...
        print("The Docker container may be processing slowly")
    except requests.exceptions.ConnectionError:
        print("❌ Connection failed - Docker containers may not be running")
    except Exception as e:
        print(f"❌ Exception: {e}")
