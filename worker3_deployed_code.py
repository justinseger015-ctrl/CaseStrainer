...
class UnifiedClusteringMaster:
    ...
    def _split_cluster_by_court_type(
        ...
        """
        supreme_court_reporters = {'U.S.', 'S.Ct.', 'S. Ct.', 'L.Ed.', 'L. Ed.', 'L. Ed. 2d'}
        circuit_reporters = {'F.2d', 'F.3d', 'F. 2d', 'F. 3d', 'F.Supp.', 'F. Supp.', 'F. Supp. 2d', 'F. Supp. 3d'}
        ...
        for citation in citations:
            ...
            if parsed:
                reporter = parsed.get('reporter', '')
                # Normalize reporter for comparison
