...
Write-Log "Usage:"
Write-Log "  .\smart_docker_monitor.ps1                    # Run once"
Write-Log "  .\smart_docker_monitor.ps1 -CheckInterval 60  # Run every minute"
Write-Log "  .\smart_docker_monitor.ps1 -DryRun            # Preview actions"
