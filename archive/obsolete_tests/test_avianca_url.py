...
def test_avianca_url():
    """Test analyzing the Avianca sanctions opinion PDF URL."""
    print("\n=== TESTING AVIANCA SANCTIONS OPINION URL ===")
    ...
    try:
        ...
        try:
            ...
            if result.get("status") == "success" and result.get("text"):
                ...
                print("Submitting extracted text for citation analysis...")
                response = requests.post(
