...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("url_analyzer.log"), logging.StreamHandler()],
)
...
logger.info("Starting URL Analyzer Application")
...
@app.route("/api/url_analyzer", methods=["POST", "OPTIONS"])
def url_analyzer():
    """API endpoint to directly analyze a URL for citations."""
    ...
    try:
        ...
        logger.error(f"Error in url_analyzer: {e}")
