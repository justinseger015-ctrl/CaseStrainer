"""
CaseStrainer Flask application with a simplified Vue.js frontend.
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Visualize the network of citations in your legal documents to understand relationships between cases.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <div class="feature-icon">🤖</div>
                            <h3 class="card-title">ML Classifier</h3>
                            <p class="card-text">Use machine learning to automatically classify and validate legal citations with high accuracy.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">Verify citations against multiple authoritative sources to ensure accuracy and reliability.</p>
                        </div>
                    </div>
                </div>
            </div>
