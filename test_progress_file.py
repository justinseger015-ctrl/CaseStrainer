#!/usr/bin/env python
"""Test script to check if progress updates are working in async processing with file upload."""
...
def test_progress_updates():
    """Test if progress updates are working with file upload."""
    
    print("Testing progress updates with file upload...")
    
    # Test file path - using PDF to force async processing
    file_path = "d:\\dev\\casestrainer\\303A20-2.pdf"
