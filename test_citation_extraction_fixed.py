"""
Direct test of citation extraction functionality using the correct import
"""
...
def test_citation_extraction():
    ...
    try:
        ...
        # Import the citation extractor from the correct location
        ...
        if citations:
            ...
            for i, citation in enumerate(citations, 1):
                ...
                for key in ['citation', 'case_name', 'year', 'volume', 'reporter', 'page', 'url', 'id', 'type']:
                ...
                common_fields = {'citation', 'case_name', 'year', 'volume', 'reporter', 'page', 'url', 'id', 'type', 'metadata'}
                other_fields = set(citation_data.keys()) - common_fields
