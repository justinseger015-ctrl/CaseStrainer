...
def make_request(method, url, **kwargs):
    ...
    try:
        ...
        try:
            ...
            print("Response (non-JSON):", response.text[:500])  # Print first 500 chars if not JSON
...
def test_paste_text():
    ...
    data = {"text": "In Brown v. Board of Education, 347 U.S. 483 (1954), the Supreme Court ruled that segregation was unconstitutional."}
    return make_request("POST", url, json=data)
