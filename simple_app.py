...
def root():
    ...
    vue_dist_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'src', 'static', 'vue')
...
def serve_js(path):
    ...
    js_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'src', 'static', 'vue', 'js')
...
def serve_css(path):
    ...
    css_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'src', 'static', 'vue', 'css')
...
def api_upload():
    ...
    return {
        ...
        "citations": [
            ...
            {"text": "347 U.S. 483", "valid": True, "name": "Brown v. Board of Education"},
