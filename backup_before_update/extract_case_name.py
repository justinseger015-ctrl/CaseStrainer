...
def extract_case_name_best(content: str, citation: str, input_type: str = 'text', source_url: str = None) -> str:
    ...
    try:
        ...
        try:
            ...
            case_name, _, _ = extract_case_name_triple_comprehensive(content, citation)
            return case_name or ""
...
def extract_case_name_triple_with_debugging(text: str, citation: str, api_key: str = None, context_window: int = 100) -> dict:
    ...
    try:
        ...
        if result['case_name'] == "N/A":
            ...
            try:
                from src.case_name_extraction_core import extract_case_name_triple_comprehensive
                case_name, extracted_date, canonical_name = extract_case_name_triple_comprehensive(text, citation)
