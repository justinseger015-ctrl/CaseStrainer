import { r as ref, s as onMounted, u as useRoute, p as computed, c as createElementBlock, o as openBlock, b as createBaseVNode, v as createStaticVNode, l as createCommentVNode, x as normalizeClass, y as withDirectives, g as createTextVNode, z as vModelText, t as toDisplayString, A as withModifiers, B as normalizeStyle, d as createVNode, C as useRouter } from "./vendor-0f3ixpnm.js";
import { u as useRecentInputs, R as RecentInputs, a as analyze } from "./RecentInputs-R_Im7MPW.js";
import { _ as _export_sfc } from "./index-BAtGweOG.js";
...
const _hoisted_36 = { class: "progress-info mb-3" };
const _hoisted_37 = { class: "progress-stats" };
const _hoisted_38 = { class: "stat" };
const _hoisted_39 = { class: "stat" };
const _hoisted_40 = { class: "progress-container" };
const _hoisted_41 = {
  class: "progress",
  style: { "height": "1.5rem", "border-radius": "0.75rem" }
};
const _hoisted_42 = ["aria-valuenow"];
const _hoisted_43 = { class: "progress-text" };
const _hoisted_44 = { class: "recent-inputs-sidebar-container" };
const _sfc_main = {
  __name: "HomeView",
  setup(__props) {
    ...
    const startProgressTracking = () => {
      ...
      progressTotal.value = estimatedCitations.value || 10;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[31] || (_cache[31] = createBaseVNode("div", { class: "background-pattern" }, null, -1)),
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, [
              _cache[30] || (_cache[30] = createStaticVNode('<div class="hero-content" data-v-de4ca433><div class="hero-text" data-v-de4ca433><h1 class="hero-title" data-v-de4ca433><i class="bi bi-shield-check me-3" data-v-de4ca433></i> Legal Citation Verification </h1><p class="hero-subtitle" data-v-de4ca433> Upload legal documents, paste text, or provide URLs to automatically extract and verify citations against authoritative legal databases. </p></div><div class="experimental-banner" data-v-de4ca433><i class="bi bi-flask me-2" data-v-de4ca433></i><strong data-v-de4ca433>Experimental Use:</strong> This tool is for research and educational purposes. Always verify results independently. </div></div>', 1)),
              createBaseVNode("div", _hoisted_5, [
                ...
                isAnalyzing.value ? (openBlock(), createElementBlock("div", _hoisted_35, [
                  createBaseVNode("div", _hoisted_36, [
                    createBaseVNode("div", _hoisted_37, [
                      createBaseVNode("span", _hoisted_38, [
                        _cache[28] || (_cache[28] = createBaseVNode("i", { class: "bi bi-list-ol text-primary" }, null, -1)),
                        createTextVNode(" " + toDisplayString(progressCurrent.value) + " of " + toDisplayString(progressTotal.value) + " citations ", 1)
                      ]),
                      createBaseVNode("span", _hoisted_39, [
                        _cache[29] || (_cache[29] = createBaseVNode("i", { class: "bi bi-clock text-primary" }, null, -1)),
                        createTextVNode(" " + toDisplayString(formatTime(elapsedTime.value)) + " elapsed ", 1)
                      ])
                    ])
                  ]),
                  createBaseVNode("div", _hoisted_40, [
                    createBaseVNode("div", _hoisted_41, [
                      createBaseVNode("div", {
                        class: normalizeClass(["progress-bar progress-bar-striped progress-bar-animated", progressBarClass.value]),
                        role: "progressbar",
                        ...
                        createBaseVNode("span", _hoisted_43, toDisplayString(progressPercent.value) + "%", 1)
                      ], 14, _hoisted_42)
                    ])
                  ])
                ])) : createCommentVNode("", true)
        ...
        _cache[32] || (_cache[32] = createStaticVNode('<div class="container" data-v-de4ca433><div class="features-section" data-v-de4ca433><div class="text-center mb-4" data-v-de4ca433><h2 class="text-white mb-3" data-v-de4ca433>Powerful Citation Analysis Features</h2><p class="text-white opacity-75" data-v-de4ca433>Everything you need for comprehensive legal citation verification</p></div><div class="features-grid" data-v-de4ca433><div class="feature-card" data-v-de4ca433><div class="feature-icon" data-v-de4ca433><i class="bi bi-search" data-v-de4ca433></i></div><h4 class="feature-title" data-v-de4ca433>Smart Detection</h4><p class="feature-description" data-v-de4ca433>Automatically identifies and extracts citations from complex legal documents using advanced pattern recognition.</p></div><div class="feature-card" data-v-de4ca433><div class="feature-icon" data-v-de4ca433><i class="bi bi-shield-check" data-v-de4ca433></i></div><h4 class="feature-title" data-v-de4ca433>Accuracy Verification</h4><p class="feature-description" data-v-de4ca433>Cross-references citations against authoritative legal databases to ensure accuracy and validity.</p></div><div class="feature-card" data-v-de4ca433><div class="feature-icon" data-v-de4ca433><i class="bi bi-lightning" data-v-de4ca433></i></div><h4 class="feature-title" data-v-de4ca433>Instant Analysis</h4><p class="feature-description" data-v-de4ca433>Get comprehensive results in seconds with detailed breakdowns of citation quality and completeness.</p></div><div class="feature-card" data-v-de4ca433><div class="feature-icon" data-v-de4ca433><i class="bi bi-file-earmark-text" data-v-de4ca433></i></div><h4 class="feature-title" data-v-de4ca433>Multiple Formats</h4><p class="feature-description" data-v-de4ca433>Supports PDF, Word documents, plain text, and direct URL analysis for maximum flexibility.</p></div></div></div></div>', 1))
      ]);
    };
  }
};
const HomeView = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de4ca433"]]);
export {
  HomeView as default
};
//# sourceMappingURL=HomeView-jIsVkpZi.js.map
