...
from src.complex_citation_integration import process_text_with_complex_citations, calculate_citation_statistics
...
App. Oct. 2, 2018) (Doe II) (unpublished),"""
    ...
    try:
        ...
        results_data = process_text_with_complex_citations(test_paragraph, verifier)
