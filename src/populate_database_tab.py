...
def get_unverified_citations():
    ...
    cursor.execute("SELECT * FROM unconfirmed_citations WHERE verification_status IS NULL OR verification_status = 'UNVERIFIED'")
...
def main():
    ...
    print("\nPopulation complete")
    print("You can now run verify_database_citations.py to verify these citations using the multi-source tool")
