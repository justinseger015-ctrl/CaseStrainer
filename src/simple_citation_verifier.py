...
LANDMARK_CASES = {
    "410 U.S. 113": {"name": "Roe v. Wade", "year": 1973, "description": "Established a woman's legal right to an abortion"},
    "347 U.S. 483": {"name": "Brown v. Board of Education", "year": 1954, "description": "Declared segregation in public schools unconstitutional"},
    "384 U.S. 436": {"name": "Miranda v. Arizona", "year": 1966, "description": "Established the Miranda rights for criminal suspects"},
    "576 U.S. 644": {"name": "Obergefell v. Hodges", "year": 2015, "description": "Legalized same-sex marriage nationwide"}
}
