...
def wait_for_processing(analysis_id: str, timeout: int = PROCESSING_TIMEOUT) -> TestResult:
...
def test_text_paste() -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error in text paste test",
            error=e
        )
...
def test_url_input() -> TestResult:
    ...
    try:
        ...
        response = requests.post(f"{BASE_URL}/api/direct_url_analyze", data=data, headers=headers)
        ...
        return TestResult(
            success=False,
            message="Error in URL input test",
            error=e
        )
...
def test_verified_tab(analysis_id: str) -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error testing verified citations tab",
            error=e
        )
...
def test_unconfirmed_tab(analysis_id: str) -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error testing unconfirmed citations tab",
            error=e
        )
...
def test_courtlistener_tab(analysis_id: str) -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error testing CourtListener cases tab",
            error=e
        )
...
def test_courtlistener_gaps_tab(analysis_id: str) -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error testing CourtListener gaps tab",
            error=e
        )
...
def test_google_scholar_tab(analysis_id: str) -> TestResult:
    ...
    try:
        ...
        return TestResult(
            success=False,
            message="Error testing Google Scholar cases tab",
            error=e
        )
    ...
    for tab_name, test_func in tabs.items():
        ...
        try:
            ...
            tab_results[tab_name] = TestResult(
                success=False,
                message=f"Error testing {tab_name} tab",
                error=e
            )
            success = False
