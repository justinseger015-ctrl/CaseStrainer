"""
Washington Court Briefs Downloader to User Directory

This script downloads briefs directly from Washington Courts website
and saves them to a folder in the user's Documents directory.
"""
...
BRIEFS_DIR = os.path.join(USER_HOME, "Documents", "WA_Court_Briefs")
