...
PLAINTIFF_NAMES = [
    ...
    "State of Washington", "United States", "City of Seattle", "King County", "Department of Corrections",
    "Microsoft", "Amazon", "Boeing", "Starbucks", "Costco", "T-Mobile", "Expedia", "Zillow", "Nordstrom", "REI"
]
...
def generate_unconfirmed_citations(num_citations=100):
    ...
    for _ in range(num_citations):
        ...
        if "{:.2f}" in explanation:
            similarity = random.uniform(0.1, 0.39)  # Low similarity for unconfirmed citations
