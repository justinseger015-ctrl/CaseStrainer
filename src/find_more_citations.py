...
DEFENDANTS = [
    "City of Seattle", "King County", "State of Washington", "Microsoft", "Amazon", "Starbucks",
    "Boeing", "T-Mobile", "Costco", "Nordstrom", "REI", "Zillow", "University of Washington",
    "Department of Corrections", "Department of Social and Health Services", "Facebook", "Google",
    "Apple", "Twitter", "Uber", "Lyft", "Bank of America", "Wells Fargo", "Chase Bank", "Walmart",
    "Target", "Home Depot", "Safeway", "Kroger", "Albertsons", "Fred Meyer", "QFC", "Walgreens",
    "CVS", "Rite Aid", "McDonald's", "Burger King", "Wendy's", "Taco Bell", "KFC", "Subway",
    "Pizza Hut", "Domino's", "Papa John's", "Chipotle", "Panera Bread", "Olive Garden", "Red Robin"
]

COMPANIES = [
    "Microsoft", "Amazon", "Starbucks", "Boeing", "T-Mobile", "Costco", "Nordstrom", "REI", "Zillow",
    "Facebook", "Google", "Apple", "Twitter", "Uber", "Lyft", "Bank of America", "Wells Fargo",
    "Chase", "Walmart", "Target", "Home Depot", "Safeway", "Kroger", "Albertsons", "Fred Meyer",
    "QFC", "Walgreens", "CVS", "Rite Aid", "McDonald's", "Burger King", "Wendy's", "Taco Bell",
    "KFC", "Subway", "Pizza Hut", "Domino's", "Papa John's", "Chipotle", "Panera", "Olive Garden"
]
...
SUBJECTS = [
    "Estate of Smith", "Marriage of Johnson", "Adoption of Williams", "Guardianship of Brown",
    "Conservatorship of Jones", "Bankruptcy of Miller", "Dissolution of Davis LLC", "Probate of Garcia",
    "Custody of Rodriguez", "Parental Rights of Wilson", "Martinez Trust", "Anderson Corporation",
    "Taylor Partnership", "Thomas Foundation", "Hernandez Estate", "Moore Property", "Martin Assets"
]
...
def load_unconfirmed_citations(filename='downloaded_briefs/all_unconfirmed_citations.json'):
...
def save_unconfirmed_citations(citations, filename='downloaded_briefs/all_unconfirmed_citations.json'):
...
def verify_citation(citation_text, case_name=None):
    ...
    try:
        ...
        if landmark_info:
            print(f"CONFIRMED: Found landmark case: {landmark_info['name']} ({citation_text})")
            return True
...
def find_unconfirmed_citations(count=50):
    ...
    for citation in random_citations:
        ...
        if is_confirmed:
            ...
            citation["explanation"] = "Citation not found in any legal database. This may be a fictional case."
...
def add_to_unconfirmed_database(new_unconfirmed):
    ...
    document_name = f"Generated_Citations_{datetime.now().strftime('%Y%m%d_%H%M%S')}.pdf"
...
def main():
    ...
    if unconfirmed:
        ...
        if success:
            print(f"Successfully added {len(unconfirmed)} new unconfirmed citations to the database")
        else:
