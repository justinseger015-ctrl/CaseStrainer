...
def download_brief(brief_url):
    ...
    try:
        ...
        response = requests.get(brief_url, headers=headers, timeout=DEFAULT_REQUEST_TIMEOUT)
    ...
    try:
        ...
        if citations:
            try:
                ...
                courtlistener_results = hasattr(citation_result, 'verified') and citation_result.verified
            except Exception as e:
