...
class UltraFastPDFExtractor:
    ...
    def __init__(self):
        # Pre-compile only essential patterns
    ...
    def extract_text_ultra_fast(self, file_path: str) -> str:
        ...
        # Try pdfminer.six directly (fastest for most PDFs)
    ...
    def _extract_with_pdfminer_fast(self, file_path: str) -> Optional[str]:
        ...
        try:
            ...
            # Direct extraction without additional processing
...
class SmartPDFExtractor:
    ...
    def extract_text_smart(self, file_path: str) -> str:
        ...
        # For small files (< 1MB), use ultra-fast extraction
        ...
        # For larger files, use optimized extraction
