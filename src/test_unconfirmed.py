...
# Load API keys
try:
    from app_final import LANGSEARCH_API_KEY, COURTLISTENER_API_KEY
    print(f"Loaded API keys: LangSearch={LANGSEARCH_API_KEY[:5]}..., CourtListener={COURTLISTENER_API_KEY[:5]}...")
except ImportError:
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        try:
            ...
            print(f"Invalid number of citations: {sys.argv[1]}. Using default: {num_citations}")
