...
async def test_findlaw_citation():
    citation = "567 P.3d 625"
    url = f"https://caselaw.findlaw.com/results.html?court=&searchType=all&query={quote_plus(citation)}"
    headers = {
        ...
        "Referer": "https://caselaw.findlaw.com/"
    }
    async with aiohttp.ClientSession() as session:
        print(f"Testing FindLaw citation search: {url}")
        try:
...
if __name__ == "__main__":
    result = asyncio.run(test_findlaw_citation())
