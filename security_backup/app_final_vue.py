...
class ApplicationFactory:
    ...
    def _setup_signal_handlers(self) -> None:
        ...
        if threading.current_thread() is threading.main_thread():
            _ = signal.signal(signal.SIGINT, signal_handler, namespace=None)  # type: ignore[attr-defined]
            _ = signal.signal(signal.SIGTERM, signal_handler, namespace=None)  # type: ignore[attr-defined]
        else:
