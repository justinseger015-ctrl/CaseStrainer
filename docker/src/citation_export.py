                    ...
                    for citation in citations:
                        ...
                        for key, value in filter_criteria.items():
                            if key in citation:
                                ...
                                elif isinstance(citation[key], str) and isinstance(value, str):
    ...
    try:
        with open(filepath, 'w', encoding='utf-8') as f:
            ...
            for citation in citations:
                ...
                year_match = re.search(r'\((\d{4})\)', citation.get('citation_text', ''))
                ...
                f.write(f"  note = {{Citation: {citation.get('citation_text', '')}}},\n")
                ...
                f.write(f"  howpublished = {{Confidence: {citation.get('confidence', 0)}}},\n")
    ...
    try:
        with open(filepath, 'w', encoding='utf-8') as f:
            for citation in citations:
                ...
                f.write(f"N1  - Status: {citation.get('hallucination_status', 'unknown')}\n")
