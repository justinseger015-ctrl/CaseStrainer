...
def create_unconfirmed_citations_tab(unverified_citations):
    ...
    try:
        ...
        print(f"Created Unconfirmed Citations tab file: {UNCONFIRMED_CITATIONS_TAB_FILE}")
...
def main():
    ...
    for i, citation_data in enumerate(unverified_citations):
        ...
        print(f"Processing citation {i+1} of {len(unverified_citations)}: {citation_text}")
