...
class MultiSourceVerifier:
                ...
                if hasattr(self, method_name):
                    ...
                    if result.get("found", False):
                        return {
                            ...
                            "explanation": result.get("explanation", f"Citation verified by {source}"),
                            "source": source,
                            "format_analysis": format_analysis
                        }
    ...
    def check_courtlistener(self, citation_text, case_name=None):
        ...
        try:
            ...
            response = self.session.get(
                API_CONFIG["courtlistener"]["base_url"],
                params=params,
                headers=headers
            )
            ...
            if response.status_code == 200:
                ...
                if data.get("count", 0) > 0:
                    ...
                    if case_name and not check_name_match(case_name, result.get("case_name", "")):
                        return {
                            "found": False,
                            "confidence": 0.3,
    ...
    def check_google_scholar(self, citation_text, case_name=None):
        ...
        try:
            ...
            # Make the request
            response = self.session.get(
                API_CONFIG["google_scholar"]["base_url"],
                params=params
            )
            ...
            if response.status_code == 200:
                ...
                if results:
                    ...
                    for result in results:
                        ...
                        if citation_text in result_text:
                            # If case name was provided, check for a match
                            if case_name and not check_name_match(case_name, result_text):
                                continue
