...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("sample_citations.log"),
...
WA_CASES = [
    ...
    {"citation": "196 Wash.2d 725", "case_name": "In re Marriage of Black", "year": 2020},
    ...
    {"citation": "190 Wash.2d 775", "case_name": "State v. Sassen Van Elsloo", "year": 2018},
    {"citation": "189 Wash.2d 1", "case_name": "State v. Allen", "year": 2017},
    {"citation": "188 Wash.2d 1", "case_name": "State v. Arlene's Flowers", "year": 2017},
]

# Sample fictional cases (for unconfirmed citations)
FICTIONAL_CASES = [
    {"citation": "999 Wash.2d 123", "case_name": "State v. Fictional", "year": 2022},
    {"citation": "888 Wash.2d 456", "case_name": "Smith v. Imaginary Corp", "year": 2021},
    ...
    {"citation": "555 Wash.2d 654", "case_name": "In re Estate of Nobody", "year": 2018},
...
def generate_multitool_citations(num_citations=15):
    ...
    for i in range(num_citations):
        ...
        citation = {
            ...
            'date_added': (datetime.now() - timedelta(days=random.randint(0, 30))).isoformat()
        }
