#!/usr/bin/env python
"""Test script to check if progress updates are working with a medium file."""
...
def test_progress_updates():
    """Test if progress updates are working with a medium file upload."""
    
    print("Testing progress updates with medium file upload...")
    
    # Test file path - using medium text file
    file_path = "d:\\dev\\casestrainer\\test_medium.txt"
    ...
    data = {
        ...
        "client_request_id": f"test_medium_{int(time.time())}"
    }
