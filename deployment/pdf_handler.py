        ...
        with open(file_path, "rb") as file:
            try:
                ...
                if text and text.strip():
                    ...
                    print(
                        "PyPDF2 extraction returned empty text, trying alternative method"
                    )
            except Exception as e:
        ...
        try:
            ...
            try:
                ...
                if result.returncode == 0 and os.path.exists(output_file):
                    ...
                    if text and text.strip():
                        print(
                            f"Successfully extracted {len(text)} characters with pdftotext command line tool"
                        )
                        return text
                    else:
                    ...
                    print(
                        f"pdftotext command failed with return code {result.returncode}"
                    )
        ...
        try:
            ...
            for laparams in [
                ...
                try:
                    ...
                    if text and text.strip():
                        print(
                            f"Successfully extracted {len(text)} characters with pdfminer.six custom settings"
                        )
                        return text
                    else:
        ...
        try:
            ...
            with open(temp_file_path, "rb") as file:
                try:
                    ...
                    if text and text.strip():
                        print(
                            f"Successfully extracted {len(text)} characters with PyPDF2 specific settings"
                        )
                        return text
                    else:
